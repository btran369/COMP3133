import { GraphQLSchema, GraphQLObjectType, GraphQLString, GraphQLFloat, GraphQLID, GraphQLList, GraphQLNonNull, GraphQLInputObjectType } from "graphql";
import { UploadScalar } from "./uploadScalar.js";
...
const AuthPayloadType = new GraphQLObjectType({
  name: "AuthPayload",
  fields: {
    success: { type: new GraphQLNonNull(GraphQLString) }, // "true"/"false" for simplicity
...
const EmployeeInput = new GraphQLInputObjectType({
  ...
  fields: {
    ...
    designation: { type: new GraphQLNonNull(GraphQLString) },
    salary: { type: new GraphQLNonNull(GraphQLFloat) },
    date_of_joining: { type: new GraphQLNonNull(GraphQLString) }, // ISO string
    department: { type: new GraphQLNonNull(GraphQLString) }
  }
});
  ...
  fields: {
    ...
    AddEmployee: {
      ...
      args: {
        ...
        photo: { type: UploadScalar } // optional
      },
    ...
    UpdateEmployeeByEid: {
      ...
      args: {
        ...
        photo: { type: UploadScalar } // optional new photo
      },
